        ...
        <div class="card mb-4">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h6 class="fs-17 font-weight-600 mb-0">Edit PostOffice</h6>
                    </div>
            ...
            <form action="{{ route('updatePostOffice') }}" method="post">
                @csrf
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <select class="form-control" name="divisionId" id="divisionId"  required>
                        <option value="{{$getDivision->divisionId}}">{{$getDivision->divisionEng}} ({{$getDivision->divisionBng}})</option>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="districtId" id="districtId" required>
                     <option value="{{$getDistrict->districtId}}">{{$getDistrict->districtEng}} ({{$getDistrict->districtBng}})</option>
                    </select>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="upazilaId" id="upazilaId" required>
                        <option value="{{$getUpazila->upazilaId}}">{{$getUpazila->upazilaEng}} ({{$getUpazila->upazilaBng}})</option>
                    </select>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="postOfficeEnglish" class="form-control" placeholder="Enter District Name" required
                        value="{{ $data->postOfficeEnglish}}" required>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="postOfficeBangla" id="input-division-bangla" class="form-control"
                        placeholder="Enter District Name" value="{{ $data->postOfficeBangla }}" required>
