                ...
                <div class="card mb-4">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h6 class="fs-17 font-weight-600 mb-0">Add Municipality</h6>
                            </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="municipalityEnglish" class="form-control"
                                    placeholder="Enter District Name" required value="{{ old('municipalityEnglish') }}"
                                    required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="municipalityBangla" id="input-division-bangla"
                                    ...
                                    value="{{ old('municipalityBangla') }}" required>
