        ...
        <div class="col-sm-8 header-title p-0">
            <div class="media">
                ...
                <div class="media-body">
                    <h1 class="font-weight-bold">List of Municipality</h1>
                </div>
            </div>
        </div>
        <div class="col-sm-4 text-right p-0">
            <a href="{{ route('createMunicipality') }}" class="btn btn-success mb-2 mr-1">
                <i class="typcn typcn-plus mr-2"></i>ADD MUNICIPALITY</a>
        </div>
    </div>
        ...
        <script>
            $(document).ready(function() {
                ...
                $('#upazilaId').on('change', function() {
                    ...
                    if (upazilaId > 0) {
                        $.ajax({
                            url: "{{ route('getMunicipalityListForAdd') }}",
                            method: 'GET',
                            data: {
                                divisionId: divisionId,
                                districtId: districtId,
