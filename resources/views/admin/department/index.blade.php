        ...
        <div class="col-sm-8 header-title p-0">
            <div class="media">
                ...
                <div class="media-body">
                    ...
                    <h1 class="font-weight-bold">List of Department</h1>
                </div>
            </div>
        </div>
        ...
        <div class="card mb-4">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h6 class="fs-17 font-weight-600 mb-0">Department</h6>
                    </div>
                </div>
            </div>
            <div class="card-body">
                                    ...
                                    <tbody>
                                        ...
                                        <div class="badge badge-success">{{ $item->status ?? '' }}</div>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{ route('deleteDepartment', $item->id) }}"
                                                                ...
                                                                <div class="card-body">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" name="enName"
                                                                            class="form-control"
                                                                            placeholder="Enter Department English Name"
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for=""
                                                                            ...
                                                                            Name</label>
                                                                        <input type="text" id="input-area" name="bnName"
                                                                            class="form-control"
                                                                            placeholder="Enter Department Bangla Name"
                                                                            value="{{ $item->bnName }}">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <form action="{{ route('storeDepartment') }}" method="post">
                    @csrf
                    <div class="modal-header">
                        <h5 class="modal-title font-weight-600" id="exampleModalLabel3">ADD Department</h5>
                    ...
                    <div class="modal-body">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="input-department-bangla" name="bnName" class="input-area2 form-control" placeholder="Enter Bangla Name">
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
