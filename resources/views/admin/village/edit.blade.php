        ...
        <div class="col-sm-6 col-md-6 col-xl-8">
            ...
            <div class="body-content">
                <div class="card mb-4">
                    ...
                    <form action="{{ route('updateVillage') }}" method="post">
                        @csrf
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group" id="unionSectionId">
                                ...
                                <select class="form-control" name="unionId" id="unionId">
                                    <option value="{{ $getUnion->unionId }}">{{ $getUnion->unionEng }}
                                        ({{ $getUnion->unionBng }})</option>
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="villageEng" class="form-control"
                                    placeholder="Enter District Name" required value="{{ $data->villageEng }}" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="villageBng" id="input-division-bangla" class="form-control"
                                    placeholder="Enter District Name" value="{{ $data->villageBng }}" required>
