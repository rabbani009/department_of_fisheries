                ...
                <div class="card mb-4">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h6 class="fs-17 font-weight-600 mb-0">Add Ward</h6>
                            </div>
                            <div class="col-sm-4 text-right p-0">
                                <a href="{{ route('wardList') }}" class="btn btn-success mb-2 mr-1">
                                    <i class="typcn typcn-arrow-back-outline mr-2"></i>Back</a>
                            </div>
                        </div>
                    </div>
                    <form action="{{ route('storeWard') }}" method="post">
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="form-group" id="municipalitySectionId">
                                <label class="font-weight-600">Municipality (পৌরসভা )</label>
                                <select class="form-control" name="municipalityId" id="municipalityId" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="unionEng" class="form-control" placeholder="Enter District Name"
                                    required value="{{ old('unionEng') }}" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="unionBng" id="input-division-bangla" class="form-control"
                                    placeholder="Enter District Name" value="{{ old('unionBng') }}" required>
