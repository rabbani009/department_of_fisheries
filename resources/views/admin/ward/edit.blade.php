        ...
        <div class="col-sm-6 col-md-6 col-xl-8">
            ...
            <div class="body-content">
                <div class="card mb-4">
                    ...
                    <form action="{{ route('updateWard') }}" method="post">
                        @csrf
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group" id="municipalitySectionId">
                                ...
                                <select class="form-control" name="municipalityId" id="municipalityId" required>
                                    <option value="{{ $getMunicipality->municipalityId }}">
                                        {{ $getMunicipality->municipalityEnglish }}
                                        ({{ $getMunicipality->municipalityBangla }})</option>
                                </select>
