...
@section('content')
        ...
        <div class="col-sm-8 header-title p-0">
            <div class="media">
                ...
                <div class="media-body">
                    <h1 class="font-weight-bold">List of Upazila</h1>
                </div>
            </div>
        </div>
        <div class="col-sm-4 text-right p-0">
            <a href="{{ route('createUpazila') }}" class="btn btn-success mb-2 mr-1">
                <i class="typcn typcn-plus mr-2"></i>ADD UPAZILA</a>
        </div>
    </div>
    ...
    <div class="body-content">
        ...
        <div class="card mb-4" id="upazilaId">
        ...
        <script>
            $(document).ready(function() {
                ...
                $('#districtId').on('change', function() {
                    ...
                    $.ajax({
                        url: "{{ route('getUpazilaListForAdd') }}",
                        method: 'GET',
                        data: {
                            divisionId: divisionId,
