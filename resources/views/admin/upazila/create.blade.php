                ...
                <div class="card mb-4">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h6 class="fs-17 font-weight-600 mb-0">Add Upazila</h6>
                            </div>
                    ...
                    <form action="{{ route('storeUpazila') }}" method="post">
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="upazilaEng" class="form-control"
                                    placeholder="Enter District Name" required value="{{ old('upazilaEng') }}" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="upazilaBng" id="input-division-bangla" class="form-control"
                                    placeholder="Enter District Name" value="{{ old('upazilaBng') }}" required>
