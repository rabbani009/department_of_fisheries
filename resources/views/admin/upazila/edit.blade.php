                ...
                <div class="card mb-4">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h6 class="fs-17 font-weight-600 mb-0">Edit Upazila</h6>
                            </div>
                            <div class="col-sm-4 text-right p-0">
                                <a href="{{ route('upazilaList') }}" class="btn btn-success mb-2 mr-1">
                                    <i class="typcn typcn-arrow-back-outline mr-2"></i>Back</a>
                            </div>
                        </div>
                    </div>
                    <form action="{{ route('updateUpazila') }}" method="post">
                        @csrf
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="divisionId" id="divisionId" required>
                                    <option value="{{ $data->divisionId }}">{{ $data->get_division->divisionEng }} ({{ $data->get_division->divisionBng }})
                                    </option>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="districtId" id="districtId" required>
                                    <option value="{{ $data->districtId }}">{{ $data->get_district->districtEng }}
                                        ({{ $data->get_district->districtBng }})</option>
                                </select>
                            ...
                            <div class="form-group">
                                <label for="exampleInputEmail1" class="font-weight-600">Upazila Name (English)</label>
                                <input type="text" name="upazilaEng" class="form-control"
                                    placeholder="Enter District Name" required value="{{ $data->upazilaEng }}" required>
                                @if ($errors->has('upazilaEng'))
                                    <div class="invalid-feedback">
                                        {{ 'This field is required' }}
                                    </div>
                                @endif
                            ...
                            <div class="form-group">
                                <label class="font-weight-600">Upazila Name (Bangla)</label>
                                <input type="text" name="upazilaBng" id="input-division-bangla" class="form-control"
                                    placeholder="Enter District Name" value="{{ $data->upazilaBng }}" required>
                                @if ($errors->has('upazilaBng'))
                                    <div class="invalid-feedback">
                                        {{ 'This field is required' }}
                                    </div>
                                @endif
