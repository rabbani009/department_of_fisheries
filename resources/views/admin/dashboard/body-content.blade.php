                        ...
                        <div class="card-body text-center">
                            <div class="row justify-content-center">
                                <div class="greet-user col-12 col-xl-10">
                                    <img src="{{ asset('admin') }}/assets/dist/img/happiness.svg" alt="..."
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-6">
                            ...
                            <div class="p-2 bg-white rounded p-3 mb-3 shadow-sm">
                                ...
                                <div class="badge badge-success fs-26 text-monospace mx-auto">$98<span
                                        class="opacity-50 small">.50</span></div>
                        ...
                        <div class="col-md-6 col-lg-6">
                            <!--Feedback-->
                            <div
                                class="d-flex position-relative overflow-hidden flex-column p-3 mb-3 bg-white shadow-sm rounded">
                                <div
                                    class="header-pretitle text-muted fs-11 font-weight-bold text-uppercase mb-2">
                                    Latest Feedback</div>
                                ...
                                <div class="d-flex">
                                    <div>
                                        <img class="d-block rounded-circle" width="32"
                                            src="{{ asset('admin') }}/assets/dist/img/avatar-5.jpg">
                                    </div>
                                    <div class="pl-3">
                                        Nothing bad to say<br /> at this point 😌
                                        <a class="d-block mt-1 small opacity-75"
                                            href="cdn-cgi/l/email-protection#b2dad7c0dfd3dcc1c6d3c0dbd9ddc4f2d5dfd3dbde9cd1dddf">Write
                                            back</a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6 col-lg-6">
                            ...
                            <div class="p-2 bg-white rounded p-3 mb-3 shadow-sm">
                                ...
                                <span class="small text-monospace mx-auto">$4,480<span
                                        class="opacity-50">.00</span>
                                </span>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-6">
                        ...
                        <div class="card-header">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div class="text-right">
                                    <div class="actions">
                                        <a href="index.html#" class="action-item"><i
                                                class="ti-reload"></i></a>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="avatar-group">
                                                    <a href="user_profile.html" class="avatar avatar-xs"
                                                        data-toggle="tooltip" title="Melissa Ayre">
                                                        <img src="{{ asset('admin') }}/assets/dist/img/avatar-1.jpg"
                                                            class="avatar-img rounded-circle" alt="...">
                                                    </a>
                                                    <a href="user_profile.html" class="avatar avatar-xs"
                                                        data-toggle="tooltip" title="Karen Robinson">
                                                        <img src="{{ asset('admin') }}/assets/dist/img/avatar-2.jpg"
                                                            class="avatar-img rounded-circle" alt="...">
                                                    </a>
                                                    <a href="user_profile.html" class="avatar avatar-xs"
                                                        data-toggle="tooltip" title="Miyah Myles">
                                                        <img src="{{ asset('admin') }}/assets/dist/img/avatar-3.jpg"
                                                            class="avatar-img rounded-circle" alt="...">
                                                    </a>
                                                    <a href="user_profile.html" class="avatar avatar-xs"
                                                        data-toggle="tooltip" title="Daniela Dewitt">
                                                        <img src="{{ asset('admin') }}/assets/dist/img/avatar-4.jpg"
                                                            class="avatar-img rounded-circle" alt="...">
                                                    </a>
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                <a href="index.html#" class="btn btn-danger-soft btn-sm"><i
                                        ...
                                        <tr>
                                            <td>
                                                <div class="avatar-group">
                                                    ...
                                                    <a href="user_profile.html" class="avatar avatar-xs"
                                                        data-toggle="tooltip" title="Daniela Dewitt">
                                                        <img src="{{ asset('admin') }}/assets/dist/img/avatar-5.jpg"
                                                            class="avatar-img rounded-circle" alt="...">
                                                    </a>
                                                </div>
                                            </td>
