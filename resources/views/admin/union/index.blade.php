...
@section('content')
        ...
        <div class="col-sm-8 header-title p-0">
            <div class="media">
                ...
                <div class="media-body">
                    <h1 class="font-weight-bold">List of Union</h1>
                </div>
            </div>
        </div>
        <div class="col-sm-4 text-right p-0">
            <a href="{{ route('createUnion') }}" class="btn btn-success mb-2 mr-1">
                <i class="typcn typcn-plus mr-2"></i>ADD UNION</a>
        </div>
    </div>
    ...
    <div class="body-content">
        ...
        <div class="card mb-4" id="unionId">
        </div>
    </div>
    @push('js')
        <script>
