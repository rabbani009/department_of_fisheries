...
@section('content')
        ...
        <div class="col-sm-8 header-title p-0">
            <div class="media">
                ...
                <div class="media-body">
                    ...
                    <h1 class="font-weight-bold">List of Designation</h1>
                </div>
            </div>
        </div>
        ...
        <div class="card mb-4">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h6 class="fs-17 font-weight-600 mb-0">Designation</h6>
                    </div>
                </div>
            </div>
            <div class="card-body">
                                    ...
                                    <tbody>
                                        ...
                                        <div class="badge badge-success">{{ $item->status ?? '' }}</div>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{ route('deleteDesignation', $item->id) }}"
                                                                ...
                                                                <div class="card-body">
                                                                    <div class="form-group">
                                                                        <label for="exampleInputEmail1"
                                                                            class="font-weight-600">English
                                                                            Name</label>
                                                                        <input type="text" name="enName"
                                                                            class="form-control"
                                                                            placeholder="Enter Designation English Name"
                                                                            required value="{{ $item->enName }}">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="exampleInputEmail1"
                                                                            class="font-weight-600">Bangla
                                                                            Name</label>
                                                                        <input type="text" name="bnName"
                                                                            class="form-control"
                                                                            placeholder="Enter Designation Bangla Name"
                                                                            value="{{ $item->bnName }}">
    ...
    <div class="modal fade bd-example-modal-lg show" id="addModal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <form action="{{ route('storeDesignation') }}" method="post">
                    @csrf
                    <div class="modal-header">
                        <h5 class="modal-title font-weight-600" id="exampleModalLabel3">ADD Designation</h5>
                    ...
                    <div class="modal-body">
                        <div class="card-body">
                            <div class="form-group">
                                <label for="exampleInputEmail1" class="font-weight-600">English Name</label>
                                <input type="text" name="enName" class="form-control" placeholder="Enter English Name"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="bnName" id="input-department-bangla" class="form-control" placeholder="Enter Bangla Name">
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
