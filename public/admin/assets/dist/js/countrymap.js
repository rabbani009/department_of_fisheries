    ...
    function p() {
        ...
        function vo(e) {
            if (
                ((he.style.width = ""),
                (fe.style.width = ""),
                b ? ((xe = he.offsetWidth) < 1 && (xe = he.parentNode.offsetWidth), (fe.style.width = xe + "px")) : ((xe = void 0 === _.width ? 800 : _.width), (he.style.width = xe + "px")),
                (xe *= 1),
                n.calibrate ? (((Ee = {}).x = -1 * n.calibrate.x_adjust), (Ee.y = -1 * n.calibrate.y_adjust), (Ee.x2 = Ee.x + n.calibrate.width), (Ee.y2 = (Ee.x2 - Ee.x) / n.calibrate.ratio)) : (Ee = n.initial_view),
                (ze = Ee.x2 - Ee.x),
                (Me = Ee.y2 - Ee.y),
                (we = xe / (Te = ze / Me)),
                (Ae = ze / 1e3),
        ...
        function bo() {
            ...
            !(function () {
                ...
                for (var n in E) for (var a in ((nt[n] = Object.create(e)), E[n].url && (nt[n].zoomable = !1), E[n])) "default" != E[n][a] && (nt[n][a] = E[n][a]), "yes" == E[n][a] && (nt[n][a] = !0), "no" == E[n][a] && (nt[n][a] = !1);
            })(),
                (function () {
                    for (var e in ((ct = function (e) {
                        ...
                        "us" != a || ("GU" != e && "PR" != e && "VI" != e && "MP" != e && "AS" != e) || (ot[e].hide = "yes"),
                        "us" != a || !H || ("VT" != e && "NJ" != e && "DE" != e && "DC" != e && "NH" != e && "MA" != e && "CT" != e && "RI" != e && "MD" != e) || (ot[e].hide_label = "yes"),
                        d[e]))
                            "default" != d[e][n] && (ot[e][n] = d[e][n]), "yes" == d[e][n] && (ot[e][n] = !0), "no" == d[e][n] && (ot[e][n] = !1);
                    ...
                    lt)) {
                        for (var n in ((it[i] = Object.create(e)), lt[i]))
                            "overwrite_image_location" != n
                                ? ("region" == n && (it[i].display = "region"), "default" != lt[i][n] && (it[i][n] = lt[i][n]), "yes" == lt[i][n] && (it[i][n] = !0), "no" == lt[i][n] && (it[i][n] = !1))
                ...
                (function () {
                    ...
                    for (var o in t) for (var n in ((ut[o] = Object.create(e)), t[o])) "default" != t[o][n] && (ut[o][n] = t[o][n]), "yes" == t[o][n] && (ut[o][n] = !0), "no" == t[o][n] && (ut[o][n] = !1);
                })();
        }
        function xo(e, t) {
            if ("lambert" == n.proj)
        ...
        function wo(e) {
            ...
            var t,
                ...
                c = ze * ke,
                m = Me * ke;
            return (n -= 0.5 * (r / l - r)), (a -= 0.5 * (s / l - s)), (r /= l) / (s /= l) > Te ? ((a -= (m * (t = r / c) - s) / 2), (s = r / Te)) : ((n -= (c * (t = s / m) - r) / 2), (r = s * Te)), { x: n, y: a, w: r, h: s, r: t };
        }
        function ko(e) {
            if (e) {
                qe.stop();
            ...
            Ze.hide(),
                ...
                "out" != i && "manual" != i
                    ? (qe.stop(),
                      ...
                      e.animate({ "stroke-width": e.sm.border_hover_size * (xe / ze) * Ae * 1.25 }, 1e3 * S))
        ...
        function Lo(e) {
            ...
            if (!e) {
                ...
                if (
                    ...
                    (yt = p),
                    "object" == typeof x
                        ? (((gt = {}).sm = { type: "manual", zp: 1, bbox: x }), (gt.sm.zooming_dimensions = wo(gt)), (x = -1), (w = !1))
                        : -1 == x || x in vt || (x in ft ? ((Qt = ft[x]), (w = !1)) : console.log("The initial_zoom is not the id of a region or state"), (x = -1)),
                    v)
                ) {
                    vt[-2] = {};
                    var _ = vt[-2];
                    ...
                    if ((t.parent_type, m)) {
                        ...
                        if ("state" == m.sm.type && t.pill) {
                            ...
                            if (
                                ...
                                m.sm.image && (G.sm.over_attributes.fill = ot[m.sm.id].hover_color),
                        ...
                        if (
                            (("out" != v.sm.display && "all" != v.sm.display) || v.sm.hide ? s.hide() : Pe.push(s),
        ...
        function Yo(e) {
            ...
            (Mt = function (e) {
                var t = "center",
                    n = it[e];
                if ("image" != n.type)
                    var a = { "stroke-width": n.border * ke * Ae, stroke: n.border_color, fill: n.color, opacity: n.opacity, cursor: "pointer" },
                ...
                if ("circle" == s)
                    var _ = Se.circle(u.x, u.y, 0.5 * l),
                        h = { x: u.x - 0.5 * l * Ce, y: u.y - 0.5 * l * Ce, x2: u.x + 0.5 * l * Ce, y2: u.y + 0.5 * l * Ce };
        ...
        function Ko(e) {
            if (!e) {
                ae ? (qe.mouseup(Tt), Ne.mouseup(eo), Ze.mouseup(Pt), Ne.mouseup(si)) : (qe.hover(St, Ot), qe.click(Tt), Ne.click(eo), Ze.click(Pt), Ne.hover(si, si)),
                    b &&
                        (function () {
                            function e() {
                                $o();
                            ...
                            (Rt = function () {
                                ...
                                window.addEventListener
                                    ? (window.addEventListener("resize", Rt, !1), window.addEventListener("orientationchange", Rt, !1))
                                    : (window.attachEvent("resize", Rt, !1), window.attachEvent("orientationchange", Rt, !1));
                            ie &&
            ...
            if (!(he.offsetWidth < 1)) {
                ...
                qe &&
                    ...
                    (qe.forEach(function (t) {
                        t.attr({ "stroke-width": e }), (t.sm.attributes["stroke-width"] = e), (t.sm.over_attributes["stroke-width"] = t.sm.border_hover_size * (xe / ze) * Ae * 1.25);
                    }),
                    Ye.forEach(function (e) {
                        "image" != it[e.sm.id].type &&
                            ((e.sm.attributes["stroke-width"] = it[e.sm.id].border * (xe / ze) * Ae * 1.25),
                            (e.sm.over_attributes["stroke-width"] = it[e.sm.id].hover_border * (xe / ze) * Ae * 1.25),
                      ...
                      set_pos: function (e, t, o) {
                          if (B) {
                              ...
                              if ((o && o.sm.on_click && ("yes" == I || ("auto" == I && xe < 401))) || i) {
                                  ...
                                  if (((O = 0 + 0.5 * we), t > (S = 0 + 0.5 * xe) && e > O)) r = 4;
                                  else if (t < S && e > O) r = 3;
                                  else if (t > S && e < O) r = 2;
                                  else var r = 1;
                                  "below" == P ? (3 == r && (r = 1), 4 == r && (r = 2)) : "above" == P && (1 == r && (r = 3), 2 == r && (r = 4)),
                                      1 == r
                                          ? ((B.style.bottom = "auto"), (B.style.top = e + 5 + "px"), (B.style.left = t + 5 + 5 + "px"), (B.style.right = "auto"))
                                          : 2 == r
                                          ? ((B.style.bottom = "auto"), (B.style.top = e + 5 + "px"), (B.style.right = xe - t + 5 + "px"), (B.style.left = "auto"))
                                          : 3 == r
                                          ? ((B.style.bottom = we - e + 5 + "px"), (B.style.top = "auto"), (B.style.left = t + 5 + 3 + "px"), (B.style.right = "auto"))
                                          : ((B.style.bottom = we - e + 5 + "px"), (B.style.top = "auto"), (B.style.right = xe - t + 5 + "px"), (B.style.left = "auto"));
                              }
                          }
                      },
                      hide: function () {
